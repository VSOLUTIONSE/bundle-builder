...
export default function ProductCard({ product }: { product: ProductData }) {
  ...
  return (
    <div
      className={`flex w-full flex-row items-center gap-[19px] overflow-hidden rounded-[10px] border-2 bg-white px-[11px] py-[11px] md:w-[calc(50%-7.5px)] ${
        qty > 0 ? 'border-[rgba(78,47,210,0.7)]' : 'border-[rgba(78,47,210,0.2)]'
      }`}
    >
      ...
      <div className="flex flex-1 flex-col gap-[10px]">
        ...
        <div className="flex items-end gap-[10px]">
          <QuantityStepper
            ...
            disabled={product.free && qty <= (product.minQty ?? 0)}
          />
