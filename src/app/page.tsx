  ...
  return (
    <BuilderProvider>
      <div className="mx-auto w-full max-w-[1440px] bg-white px-0 py-8 tab:px-[105px] desktop:px-[122px] desktop:py-[49px]">
        <h1 className="mb-6 text-center font-['Gilroy-Bold',sans-serif] text-[2rem] leading-[35.1px] text-[rgba(31,31,31,1)] tracking-[-0.064px] desktop:hidden">
          Let&apos;s get started!
        </h1>
        <div className="flex flex-col desktop:flex-row desktop:gap-[29px]">
